...
PAPER_REPLICATION_VALUES = [
    ...
    ('baby2', 150, 6, 600, 140/60, 160/60, 30),
    # ('camera', 120, 20, 45, 100, 300),
    # ('face', 50, 1000, 50/60, 1, 30),
...
def replicate_study():
    ...
    for name, amplification_factor, pyramid_levels, cutoff, lower_hertz, upper_hertz, framerate in PAPER_REPLICATION_VALUES:
        source_filename = name + '.mp4'
